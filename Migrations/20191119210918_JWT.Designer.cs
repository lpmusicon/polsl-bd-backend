...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackendProject.Admin", b =>
                {
            ...
            modelBuilder.Entity("BackendProject.Doctor", b =>
                {
            ...
            modelBuilder.Entity("BackendProject.ExaminationDictionary", b =>
                {
            ...
            modelBuilder.Entity("BackendProject.LaboratoryExamination", b =>
                {
            ...
            modelBuilder.Entity("BackendProject.LaboratoryManager", b =>
                {
                    b.Property<int>("LaboratoryManagerId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BackendProject.LaboratoryWorker", b =>
                {
                    b.Property<int>("LaboratoryWorkerId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BackendProject.Patient", b =>
                {
            ...
            modelBuilder.Entity("BackendProject.PatientVisit", b =>
                {
                    b.Property<int>("PatientVisitId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BackendProject.PhysicalExamination", b =>
                {
            ...
            modelBuilder.Entity("BackendProject.Receptionist", b =>
                {
                    b.Property<int>("ReceptionistId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BackendProject.LaboratoryExamination", b =>
                {
                    b.HasOne("BackendProject.ExaminationDictionary", "ExaminationDictionary")
                        .WithMany("LaboratoryExaminations")
                        .HasForeignKey("ExaminationDictionaryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BackendProject.LaboratoryManager", "LaboratoryManager")
                        .WithMany("CheckedExaminations")
                        .HasForeignKey("LaboratoryManagerId");

                    b.HasOne("BackendProject.LaboratoryWorker", "LaboratoryWorker")
                        .WithMany("PerformedExaminations")
                        .HasForeignKey("LaboratoryWorkerId");

                    b.HasOne("BackendProject.PatientVisit", "PatientVisit")
            ...
            modelBuilder.Entity("BackendProject.PatientVisit", b =>
                {
                    b.HasOne("BackendProject.Doctor", "Doctor")
                        .WithMany("PerformedVisits")
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BackendProject.Patient", "Patient")
                        .WithMany("PatientVisits")
                        .HasForeignKey("PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BackendProject.Receptionist", "Receptionist")
